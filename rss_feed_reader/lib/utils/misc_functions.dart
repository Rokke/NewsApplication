...
void showSnackbar(BuildContext context, String text, {IconData? icon = Icons.info, Color color = Colors.green, TextStyle? textStyle}) => ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Row(
          children: [
            if (icon != null)
